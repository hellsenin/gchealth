	...
	<table summary="등록정보 테이블로 허가내용을 알 수 있습니다" class="default_view">
		...
		<tbody>
			<tr>
				...
				<td class="output" >
					<label for="number1">제 <input id="number1" name="number1" type="text" style="width:43px; text-align: center; padding-left: 0px;" maxlength="5" class="t_text vam" value="${answer.NUMBER1}" readonly="readonly" <c:if test="${Bean.view_state == 'readonly'}"> disabled='disabled'</c:if>/> 호</label>
				</td>
			</tr>
			<tr>
				<th scope="row">
