...
<h2 style="padding:15px 0 15px 0;">보건소식지</h2>
...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
    ...
    <tr>
        <th scope="row" width="20%" class="title_1"><label for="sr_title">제목</label> </th>
	...
	<tr>
        <th scope="row"><label for="file_1">이미지 첨부파일 </label></th>
        <td colspan="5"><input type="file" name="file_1" id="file_1" value="첨부파일" /></td>
    </tr>
	<tr>
        <th scope="row"><label for="file_2">첨부파일 </label></th>
        <td colspan="5"><input type="file" name="file_2" id="file_2" value="첨부파일" /></td>
    </tr>
</table>
