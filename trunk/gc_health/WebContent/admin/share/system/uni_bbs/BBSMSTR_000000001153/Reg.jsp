...
<h2 style="padding:15px 0 15px 0;">보건캘린더</h2>
...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
    ...
    <tr>
        <th scope="row" class="title"><label for="option2">일정 등록일</label> </th>
        <td colspan="3" class="title_data"><input type="text" id="option2" name="option2" /><a href="javascript:Calendar_D(board.option2)"><img src="/health/open_content/images/calendar.gif" class="vat" alt=""/></a></td>
    </tr>
    <tr>
        <th scope="row" class="title"><label for="sr_name">담당부서</label> </th>
        <td colspan="3" class="title_data"><input type="text" id="sr_name" name="option1" /></td>
    </tr>
    <tr>
