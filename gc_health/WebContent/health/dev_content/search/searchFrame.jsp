	...
	<form name="searchFrm" method="post" action="/health/search/search.do" onsubmit="return checkSearchForm(this)">
        <div class="main_search" id="mainSearch">
            <fieldset class="main_total_search">
                <legend>통합검색</legend>
				<label for="method" class="blind">통합검색 구분</label>
...
<div id="container">
	<ul id="search_tab">
		<li id="search_tab_0"><a href="#search_tab_0" onclick="goMore('0');return false;" <c:if test="${param.method == 0}">class="on"</c:if>>통합검색</a></li>
		<li id="search_tab_1"><a href="#search_tab_1" onclick="goMore('1');return false;" <c:if test="${param.method == 1}">class="on"</c:if>>메뉴검색</a></li>
		<li id="search_tab_2"><a href="#search_tab_2" onclick="goMore('2');return false;" <c:if test="${param.method == 2}">class="on"</c:if>>게시판</a></li>
		<li id="search_tab_3"><a href="#search_tab_3" onclick="goMore('3');return false;" <c:if test="${param.method == 3}">class="on"</c:if>>직원/업무</a></li>
	</ul>
