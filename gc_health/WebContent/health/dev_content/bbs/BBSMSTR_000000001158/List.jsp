...
<table class="default_list" summary="약국간 의약품 나눔센터 게시판으로 번호, 판매여부, 약국명, 약품명, 회사명, 함량, 등록일로 구성">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/health/bbs/selectBoardArticle.do?categoryId=${param.categoryId}&amp;bbsId=${param.bbsId}&amp;nttId=${result.nttId}"><c:out value="${result.nttSj}" />(${result.commentCnt})</a></td>
