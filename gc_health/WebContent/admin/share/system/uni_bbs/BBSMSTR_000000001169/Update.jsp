...
<h2 style="padding:15px 0 15px 0;">영상자료실</h2>
...
<input type="hidden" name="optionCnd" value="option2" />
<input type="hidden" name="optionWrd" value="2" />
...
<div class="board_btn_set mt13">
    ...
    <span class="btn_list"><a href="/admin/bbs/selectBoardList.do?bbsId=${param.bbsId}&amp;optionCnd=option2&amp;optionWrd=${param.optionWrd}">목록보기</a></span>
</div>
</form>
