...
<table summary="제목,작성자,등록일자,연락처,내용,첨부파일 제공" class="default_write">
    ...
    <tr>
        ...
        <td colspan="3" class="title_data"><input type="text" id="option1" name="option1" value="${result.option1}" /></td>
    </tr>
    <tr>
        <th scope="row" class="title"><label for="option2">회수사유</label> </th>
        <td colspan="3" class="title_data"><input type="text" id="option2" name="option2" value="${result.option2}" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3" class="title_data"><input type="text" id="option4" name="option4" value="${result.option4}" /></td>
    </tr>
    <tr>
